...
$(document).ready(function () {
  $(".tab-17").click(function () {
    $(".btn-drop .btn-drop-inr").replaceWith('<p class="btn-drop-inr heading-SB">Blue Mode</p>');
  });
  $(".tab-18").click(function () {
    $(".btn-drop .btn-drop-inr").replaceWith('<p class="btn-drop-inr heading-SB">Dark Mode</p>');
  });
  $(".tab-19").click(function () {
    $(".btn-drop .btn-drop-inr").replaceWith('<p class="btn-drop-inr heading-SB">Grey Mode</p>');
  });
  $(".tab-20").click(function () {
    $(".btn-drop .btn-drop-inr").replaceWith('<p class="btn-drop-inr heading-SB">Light Mode</p>');
  });
...
__webpack_require__(/*! F:\Ansarians\ethernal-all\Ethernal\src\js\app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! F:\Ansarians\ethernal-all\Ethernal\src\scss\app.scss */"./src/scss/app.scss");
